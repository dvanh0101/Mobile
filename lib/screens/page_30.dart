  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                icon: Image.asset('images/tools_icon.png'),
                onPressed: () {
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        shape:
            CircularNotchedRectangle(), // Hình dạng khuyết để tạo chỗ cho nút nổi
        notchMargin:
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SizedBox(width: 40), // Khoảng trống cho FloatingActionButton ở giữa
            IconButton(
